...
simFunction<-function(seedNum,nrep){
  ...
  dnnModel1 <-deepsurv(data=DataSeg_n$trainData,
                       ...
                       learning_rate=0.03425109,
                       lr_decay= 5.923836e-05,
                       momentum=0.9106012,
  ...
  write.csv(t(r),file=paste0('C:/Users/mde4023/Downloads/StackedSurvivalData/Metabric/resultNN/NN_',seedNum,'.csv'))
...
# Directory path
path <- "C:/Users/mde4023/Downloads/StackedSurvivalData/Metabric/resultNN/"
...
simFunction<-function(seedNum,nrep){
  ...
  write.csv(t(r),file=paste0('C:/Users/mde4023/Downloads/StackedSurvivalData/Metabric/resultRF/RF_',seedNum,'.csv'))
...
##check if everything is fitted and calculate result
# Directory path
path <- "C:/Users/mde4023/Downloads/StackedSurvivalData/Metabric/resultRF/"
