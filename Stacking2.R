...
simFunctionRF<-function(seedNum,nrep){
  ...
  seed_R=seedNum
  set_seed(seed_R, seed_np = seed_R, seed_torch = seed_R)
  rfModel1 <- rfsrc(myformula,DataSeg_n$trainData)
  rfModel2 <- rfsrc(myformula,DataSeg_n$replicated_df)
  rfModel3 <- rfsrc(myformula,DataSeg_n$stacked_df)
  rfModel4 <- rfsrc(myformula,DataSeg_1$replicated_df)
  rfModel5 <- rfsrc(myformula,DataSeg_1$stacked_df)
